...
<section>
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<img src="assets/images/service.png" style="max-width:300px;" alt="service" class="image-responsive">
				</div>
				<div class="col-md-8">
					<div class="row">
						<div class="col-md-4">
...
<!-- Twitter Feed -->
	<section class="twitter-feed" style="background-color: #ffbb33;">
...
<!-- Portfolio -->
	<section class="portfolio" id="portfolio">
		<div class="container section-wrapper">
			...
			<div class="underline" style="background-color: #ffbb33;"></div>
			<div class="row">
...
<!-- Note -->
	<section class="note" style="background-color: #ffbb33;">
